...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Jan 2023 pada 20.42
...
INSERT INTO `tblreservasi` (`idpsn`, `name`, `nohp`, `address`, `email`, `datecheckin`, `datecheckout`, `typeroom`) VALUES
(1, 'Andre', '085740753047', 'Semarang', 'andre@gmail.com', '2023-01-27', '2022-12-30', 'Standard Room'),
...
(5, 'Devi', '085870550021', 'Ambarawa', 'sarwono@gmail.com', '2022-12-29', '2023-01-02', '- Single Room -');
...
--
ALTER TABLE `tblreservasi`
  MODIFY `idpsn` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
COMMIT;
